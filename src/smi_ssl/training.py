...
from .masking import PatchSpec, build_balanced_event_mask_cycle, build_patch_aligned_isolated_masks
from .baselines import interpolation_baseline, nearest_baseline, visible_mean_baseline
...
def train_bead_ssl(
    ...
    *,
    ...
    if prepared_datasets is None:
        raise ValueError("Standalone training requires explicit prepared train, validation and real-validation datasets")
